...
{
    "name" : "Creacion de Attachment en la Factura Electronica para Mexico (CFD,CFDI,CBB) FINKOK",
    "version" : "1.0",
    "author" : "Vauxoo",
    "category" : "Localization/Mexico",
    "description" : """This module creates attachment for Invoice(CFD,CFDI,CBB) FINKOK
    """,
